...
if choice == "Tutor Chat":
    ...
    if prompt := st.chat_input():
        ...
        response = f"Expert Insight: {prompt} is a key topic. In the IAL marking scheme, ensure you mention the specific scientific terminology."
...
# --- 4. PRACTICAL LAB ---
    ...
    lab = st.selectbox("Choose Lab:", ["CP 1: Vitamin C", "CP 7: Respirometer"])
